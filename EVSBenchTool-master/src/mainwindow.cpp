...
QString super_private_key = "5KAnWzTabaubofJZR4Ye29fuz5Hozw4gUgdZUJDNYdUCjHhrBpz";
QString contract_account = "evsio.token";
QString token_name = "KBT";
int trx_size = 50;
...
void MainWindow::on_pushButtonInitialize_clicked()
{
    ...
    ui->pushButtonInitialize->setText("disable");
    ...
    for (int i = 0; i < accountSize; ++i) {
        ...
        push.transferToken(super_account, to, quantity);
        bool ret = push.make_push();
